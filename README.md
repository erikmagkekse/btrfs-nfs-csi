...
See [docs/installation.md](docs/installation.md) for full setup (btrfs, NFS, Quadlet/systemd).

### 2. Driver (Kubernetes)

```bash
kubectl apply -f https://raw.githubusercontent.com/erikmagkekse/btrfs-nfs-csi/main/deploy/driver/setup.yaml
# Download and edit storageclass.yaml: set agentToken, nfsServer, agentURL
...
See [docs/operations.md](docs/operations.md) for snapshots, clones, expansion, and more.
